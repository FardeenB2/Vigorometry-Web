const menu = document.querySelector('#mobile-menu');        //calls id mobile-menu from index.html
const menuLinks = document.querySelector('.navbar__menu');      //assigns this menuLinks variable to be the container menu of navigation bar.
